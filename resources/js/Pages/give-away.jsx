...
const SearchingBar = ({ search_artikel, category, subcategory }) => {
    ...
    return (
        <form onSubmit={Searching}>
            ...
            <button
                type="submit"
                className="text-black absolute right-2 bottom-2.5 bg-master hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  submit-btn font-sm me-3 "
                onClick={Searching}
            >
                Search
            </button>
